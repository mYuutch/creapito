...
<template>
    <AppLayout>
        ...
        <div class="w-full h-screen flex items-center justify-center">
            <h1 class="font-neulis font-medium text-[#C3A181] text-2xl md:text-5xl xl:text-6xl">Créapito : Créez, Colorez, Enchantez!</h1>
        </div>

        <div class="w-full my-24">
            <h2>Les Nouveautés</h2>
            <div class="max-w-7xl flex mx-auto gap-8 p-12">
            <ProductCard  v-for="product in latest" :product="product"/>
        </div>

        </div>

        <div class="w-full bg-[#C3A181]  my-24 lg:rounded-b-[10%] shadow-xl p-24 flex flex-col items-center">
            ...
            <Link :href="route('products')" class="bg-white px-8 py-2 rounded mt-24 mb-24">Voir tout les produits</Link>
        </div>
...
<input type="hidden" name="redirect" value="https://localhost:8000/">
